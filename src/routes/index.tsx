...
function Index() {
    ...
    const [buckets] = useState<Bucket[]>([
      { id: '1', name: 'Dining', recurrence_period_type: RecurrencePeriodType.Monthly, spending_limit: 15000 },
      { id: '2', name: 'Entertainment', recurrence_period_type: RecurrencePeriodType.Weekly, spending_limit: 2000 },
    ]);
